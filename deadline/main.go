...
func main() {
	...
	// Deadline context as a child of base, and cancel as CancelFunc which we can use to send
	// cancellation message
	withTimeout, cancel := context.WithDeadline(base, time.Now().Add(time.Second*3))
